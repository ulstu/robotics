...
REM 
set "IMAGE=ulstu-robotics"
set "FLAVOR=labs"
set "ROBOT_PANEL_PORT=8010"
set "VS_PORT=31420"
set "WEBOTS_STREAM_PORT=1111"
set "DOCKER_DIR=%~dp0"
set "PROJECT_DIR=%~dp0"
...
docker exec -it %IMAGE%-%FLAVOR% ln -s /ulstu/repositories/ulstu_turtlebot_gazebo /ulstu/ros2_ws/src/ulstu_turtlebot_gazebo
