...
### Задание
1. В среде Gazebo необходимо разработать собственный мир. Возможно в качестве основы использовать стандартный мир из пакетов Gazebo (willow garage, turtlebot3_house). Требования к разрабатываемому миру (к той части, которая делается непосредсвенно студентом, а не берется в готовом виде из Gazebo): 
